                    ...
                    <dl>
                        ...
                        <dd class="operate">
                            @if($item->role_type == 0 && $member->group_level != 0)
                                <button class="btn btn-danger btn-sm project-quit-btn" title="退出" data-id="{{$item->project_id}}" data-toggle="tooltip" data-placement="bottom">
                                    <i class="fa fa-power-off"></i>
                                    退出
                                </button>
                            @elseif($item->role_type == 1 || $member->group_level == 0)
                                <a href="{{route('project.members',['id'=>$item->project_id])}}" class="btn btn-danger btn-sm project-user-btn" title="管理文档成员" data-toggle="tooltip" data-placement="bottom">
                            ...
                            <a class="btn btn-default btn-sm article-edit-btn" href="{{route('document.index',['id'=>$item->project_id])}}" target="_blank" title="编辑文档" data-toggle="tooltip" data-placement="bottom"><span class="btn-input"><i class="fa fa-edit"></i> 编辑文档</span></a>
                        </dd>
                    </dl>
                </div>
                @endforeach
